...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        # change from 0.7 to 0.9, performance worse, from 0.7 to 0.5, slightly better for IDF1
        ...
        # TODO: change thres from 0.5 to 1 
        # ===!!== use 0.5 for people tracking and 1 for hand tracking
