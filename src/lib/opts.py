...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--handEpic', default=False, help='hand detector')
    self.parser.add_argument('--train_handDoh', default=False, help='hand detector')
    self.parser.add_argument('--val_handDoh', default=False, help='hand detector')
    self.parser.add_argument('--test_handDoh', default=False, help='hand detector')
    self.parser.add_argument('--peopleDoh', default=False, help='people detector on DOH dataset')
  ...
  def init(self, args=''):
    default_dataset_info = {
      ...
      'hand': {'default_resolution': [608, 1088], 'num_classes': 1,
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'jde', 'nID': 33},
    }
    class Struct:
    ...
    print("==track detector==", dataset, dataset.nID)
